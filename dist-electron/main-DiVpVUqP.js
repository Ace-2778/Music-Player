...
const mpegParserLoader = {
  ...
  async load() {
    return (await import("./MpegParser-B57mlKxj.js")).MpegParser;
  }
};
...
const asfParserLoader = {
  ...
  async load() {
    return (await import("./AsfParser-BpP6Cx1D.js")).AsfParser;
  }
};
const dsdiffParserLoader = {
  ...
  async load() {
    return (await import("./DsdiffParser-X2vreSJL.js")).DsdiffParser;
  }
};
const aiffParserLoader = {
  ...
  async load() {
    return (await import("./AiffParser-BODrkH_d.js")).AIFFParser;
  }
};
const dsfParserLoader = {
  ...
  mimeTypes: ["audio/dsf"],
  async load() {
    return (await import("./DsfParser-BmoEVSRE.js")).DsfParser;
  }
};
const flacParserLoader = {
  ...
  async load() {
    return (await import("./FlacParser-BJLswBcy.js").then((n) => n.d)).FlacParser;
  }
};
const matroskaParserLoader = {
  ...
  async load() {
    return (await import("./MatroskaParser-BE8s15Yo.js")).MatroskaParser;
  }
};
const mp4ParserLoader = {
  ...
  async load() {
    return (await import("./MP4Parser-SbnZWieG.js")).MP4Parser;
  }
};
const musepackParserLoader = {
  ...
  async load() {
    return (await import("./MusepackParser-BeMmhjGo.js")).MusepackParser;
  }
};
const oggParserLoader = {
  ...
  async load() {
    return (await import("./OggParser-DqEnn1w7.js")).OggParser;
  }
};
const wavpackParserLoader = {
  ...
  async load() {
    return (await import("./WavPackParser-B2jwNoHt.js")).WavPackParser;
  }
};
const riffParserLoader = {
  ...
  async load() {
    return (await import("./WaveParser-mNEZqr6S.js")).WaveParser;
  }
};
...
ipcMain$1.handle("save-lyrics-options", (event, options) => {
  const currentOptions = store.get("lyricsOptions", {});
